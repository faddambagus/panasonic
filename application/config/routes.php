...
/* URL route khusus user */
$route['login'] = 'Landing_Page/login';
$route['home_user'] = 'User/home'; 
$route['order'] = 'User/order';
$route['report'] = 'User/report';
$route['services'] = 'User/services';
$route['profile_user'] = 'User/profile';

/* URL route khusus admin */
$route['register'] = 'Landing_Page/register';
$route['allReport'] = 'Admin/allReport';
$route['profile_admin'] = 'Admin/profile';
$route['delete_order/(:num)'] = 'Admin/delete_order/$1';
