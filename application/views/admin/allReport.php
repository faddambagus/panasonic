			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					<ul class="nav navbar-nav mr-auto">
						...
						<li class="nav-item dropdown active">
							<a href="<?= base_url('allReport'); ?>" class="nav-link">All Report</i></a>
						</li>

						<li class="nav-item dropdown">
							<a href="<?= base_url('profile_admin'); ?>" class="nav-link">Profile</i></a>
						</li>
							...
							<tbody>
								...
								foreach ($allOrder as $row) : ?>
									<tr>
										...
										<td class="ps-0 pt-2">
											<a href="<?= base_url(); ?>delete_order/<?= $row['id_order']; ?>" class="btn btn-link text-danger">
