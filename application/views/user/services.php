...
<head>
	...
	<link rel="stylesheet" href="assets/css/bvideo.css">
</head>
<!-- CSS end-->
	...
	<div class="hero-wrap">
		...
		<div class="card">
			<video autoplay loop muted>
				<source src="assets/images/sepatu.mp4">
			</video>
			...
			<div class="container">
				<div class="row grid-style">
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<img src="assets/images/sneakers.jpg" alt="" class="img-fluid">
							</div><!-- end media -->

							<div class="blog-meta big-meta">
								<h4><a href="" title="">Sneakers</a></h4>
								<h5 style="color:white">Kami Mencuci Hingga Sepatu Kamu Bersih </h5>
								<small>
									<title="">RP50K</a>
								</small>
							</div>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<img src="assets/images/boots.jpg" alt="" class="img-fluid">
							</div><!-- end media -->
							<div class="blog-meta big-meta">
								<h4><a href="" title="">Boots</a></h4>
								<h5 style="color:white">Kami Mencuci Hingga Sepatu Kamu Bersih </h5>
								<small>
									<title="">RP50K</a>
								</small>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<img src="assets/images/slipon.jpg" alt="" class="img-fluid">
							</div><!-- end media -->

							<div class="blog-meta big-meta">
								<h4><a href="" title="">Slip On</a></h4>
								<h5 style="color:white">Kami Mencuci Hingga Sepatu Kamu Bersih </h5>
								<small>
									<title="">RP50K</a>
								</small>
					...
					<div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
						<div class="blog-box">
							<div class="post-media">
								<img src="assets/images/loafers.jpg" alt="" class="img-fluid">
							</div><!-- end media -->

							<div class="blog-meta big-meta">
								<h4><a href="" title="">Loafers</a></h4>
								<h5 style="color:white">Kami Mencuci Hingga Sepatu Kamu Bersih </h5>
								<small>
									<title="">RP50K</a>
								</small>
